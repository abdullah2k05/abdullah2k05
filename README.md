...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Hi%2C+I'm+Muhammad+Abdullah+%F0%9F%91%8B;Full-Stack+Product+Engineer;AI%2FML+%26+RAG+Developer;Data+Science+Student" alt="Typing SVG" />
</p>
...
- [Systems & Software Foundations](#-systems--software-foundations)
...
**Muhammad Abdullah** — Full-Stack Product Engineer, AI/ML & RAG Developer, and Data Science Student based in **Lahore, Punjab, Pakistan**.
...
![GraphRAG](https://img.shields.io/badge/GraphRAG-412991?style=flat-square&logo=openai&logoColor=white)
...
**Secure, scalable authentication system** with JWT, modern security practices & session management.

**Stack:** `MongoDB` · `Express` · `React` · `Node`

[View Repository →](https://github.com/abdullah2k05/Mern-Authentication)

---

### 🏫 Student Portal System

**Full-stack platform** for managing student records & academic data.

**Stack:** `Node.js` · `MongoDB`

[View Repository →](https://github.com/abdullah2k05)

---

### ⚡ Calculator REST API

**High-performance math computation endpoints** built with Express.js.

**Stack:** `Node.js` · `Express`

[View Repository →](https://github.com/abdullah2k05/calculator-api)

---

### 🔤 Custom String Class

**C++ string class** with dynamic memory management (stack & heap).
...
**Semester GPA calculator** for PUCIT students.

**Stack:** `JavaScript`

[View Repository →](https://github.com/abdullah2k05/pucit-gpa-calculator)
...
## ⚙️ Systems & Software Foundations
...
**📚 Teacher Assistant — Programming Fundamentals — PUCIT (FCIT)** *(Sep 2025–Present)*
> Helping students understand C++ fundamentals, programming concepts, and problem-solving. Lahore.

**🎬 Head of Production — FCIT Information & Media Society** *(Oct 2025–Present)*
> Leading video production, event shoots, and media-related production work. Lahore.

**🎓 Campus Ambassador — The TalentBeacon** *(Apr 2025–Present)*
> Acting as a bridge between the organization and PUCIT students.

**🎓 Campus Ambassador — TechnoVerse, CUI Lahore** *(Apr 2025–Present)*

**📢 Media Team Member — Pioneer Debating Society — PUCIT** *(Dec 2025–Present)*
> Working on media coverage and visual content for society activities.

**📸 Media Team Member — PUCon, University of the Punjab** *(Mar 2025–Present)*

**🏆 Event Manager — FCIT NC Sports, PUCIT** *(Dec 2024–Present)*
...
| 🐙 GitHub | [github.com/abdullah2k05](https://github.com/abdullah2k05) |
